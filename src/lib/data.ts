import { Factory, Music, Video } from "lucide-react";

export const industriesData = [
  {
    title: "Muzička i Video Industrija",
  ...
  {
    title: "Kamenoklesarska Industrija",
